...
const LeaveManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-dark p-6">
      ...
      {showApplyForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="card w-full max-w-md">
            <h3 className="text-xl font-semibold mb-4 text-primary">Apply for Leave</h3>
      ...
      {/* Leave History */}
      <div className="card">
        <h3 className="text-xl font-semibold mb-4 text-primary">Leave History</h3>
              ...
              {leaves.map((leave) => {
                ...
                return (
                  <tr key={leave.id} className="border-b border-gray-700">
                    ...
                    <td className="py-3 px-4">{startDate.toLocaleDateString()}</td>
                    <td className="py-3 px-4">{endDate.toLocaleDateString()}</td>
                    ...
                    <td className="py-3 px-4 text-gray-400">{leave.adminComments || '-'}</td>
                  </tr>
                );
              })}
            </tbody>
