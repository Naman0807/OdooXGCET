...
const Payroll = () => {
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-white mb-2">Payroll Information</h2>
        <p className="text-gray-400">View your salary structure and payment history</p>
      </div>
      ...
      {payrollData && (
        <>
          ...
          <div className="card mb-8">
            <h3 className="text-xl font-semibold mb-6 text-primary">Current Salary Structure</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-600 pt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-semibold text-gray-300">Net Salary:</span>
              ...
              <div className="bg-gray-700 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium">
                      {formatCurrency((payrollData.salaryAllowance || 0) * 12)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Annual Deductions:</span>
                    <span className="text-red-400 font-medium">
                      {formatCurrency((payrollData.salaryDeduction || 0) * 12)}
                    </span>
                  </div>
                  <div className="border-t border-gray-600 pt-3">
                    <div className="flex justify-between">
                      <span className="text-gray-300 font-semibold">Annual Net:</span>
          ...
          {/* Salary History */}
          <div className="card">
            <h3 className="text-xl font-semibold mb-4 text-primary">Payment History</h3>
            <div className="overflow-x-auto">
                ...
                <tbody>
                  {payrollData.salaries?.map((salary) => (
                    <tr key={salary.id} className="border-b border-gray-700">
                      <td className="py-3 px-4">{getMonthName(salary.month)}</td>
                      <td className="py-3 px-4">{salary.year}</td>
                      <td className="py-3 px-4">{formatCurrency(salary.basic)}</td>
                      <td className="py-3 px-4">{formatCurrency(salary.allowance)}</td>
              ...
              {(!payrollData.salaries || payrollData.salaries.length === 0) && (
